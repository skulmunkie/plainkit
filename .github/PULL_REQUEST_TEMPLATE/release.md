...
- [ ] `CHANGELOG.md`: "Unreleased" renamed to the version and date; breaking changes under `### Breaking`; a new empty "Unreleased" added
...
1. Tag the merge commit `vX.Y.Z` and push the tag: `git tag vX.Y.Z && git push origin vX.Y.Z`.
