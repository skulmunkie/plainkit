...
const SDK_GAPS = [
    ...
    'The layout builder (`mountLayoutBuilder`, `dist/modules/layout-builder/`) moves elements by keyboard and buttons only: pointer drag and drop, the iframe device preview, reusable blocks and the Blazor `PkLayoutBuilder` wrapper are not built yet.',
