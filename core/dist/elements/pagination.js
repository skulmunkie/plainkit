...
export default define(class extends behaviour(PkElement) {
    ...
    static css = ":host{--_s: var(--pk-pagination-size,var(--space-8));display: block}nav{display: flex;flex-wrap: wrap;align-items: center;justify-content: space-between;gap: var(--space-2) var(--space-4)}[part=\"summary\"]{color: var(--color-muted);font-size: var(--text-meta);font-variant-numeric: tabular-nums}[part=\"size\"]{display: inline-flex;align-items: center;gap: var(--space-2);color: var(--color-muted);font-size: var(--text-meta)}[part=\"pages\"],[part=\"numbers\"]{display: flex;flex-wrap: wrap;align-items: center;gap: var(--gap-control)}button,select{min-inline-size: var(--_s);min-block-size: var(--_s);padding: 0 var(--space-2);border: 1px solid var(--color-border);border-radius: var(--radius-sm);background: transparent;color: var(--color-text);font: inherit;cursor: pointer}select{background: var(--color-input)}button:hover:not(:disabled){background: var(--color-surface-alt)}button[aria-current=\"page\"]{background: var(--color-accent);border-color: var(--color-accent);color: var(--btn-primary-fg);font-weight: 600}button:disabled{opacity: 0.45;cursor: default}button:focus-visible,select:focus-visible{outline: var(--focus-ring);outline-offset: 2px}.gap{padding-inline: var(--space-1);color: var(--color-muted)}[part=\"status\"]{display: none;color: var(--color-muted);font-variant-numeric: tabular-nums}[part=\"more\"]{display: none;padding-inline: var(--space-6)}:host([mode=\"simple\"]) [part=\"numbers\"]{display: none}:host([mode=\"simple\"]) [part=\"status\"]{display: block}:host([mode=\"load-more\"]) [part=\"pages\"],:host([mode=\"load-more\"]) [part=\"summary\"]{display: none}:host([mode=\"load-more\"]) [part=\"more\"]{display: inline-block}@media (max-width: 640px){:host{--_s: var(--pk-pagination-size,var(--touch-target))}[part=\"numbers\"]{display: none}[part=\"status\"]{display: block}nav{justify-content: center}}";
});
