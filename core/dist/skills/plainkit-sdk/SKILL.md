...
- `references/elements-index.md`: every tag, its group and the file that documents it (start here to find an element)
- `references/known-gaps.md`: what is not built, what not to assume
- `references/layouts.md`: page anatomies (list, record, setup, tool, wizard)
- `references/loading.md`: ways to load Plainkit, `initPlainkit`, the element loader
- `references/logging.md`: the SDK logger: levels, scopes, routes, `?pk-log=`, `PkLog`
- `references/openers.md`: `data-open`, `data-toggle`, `data-close`
- `references/patterns.md`: composed patterns (confirm delete, filter table, forms, ...)
- `references/templates.md`: full-page starting points
- `references/theming.md`: tokens and themes
- `references/tools.md`: dev tools dock, logs, logging settings, scorecard, performance, console, quality, theme editor, code explorer, gallery: `mountX(container, options)` and events
- `references/elements-actions.md`: Actions
- `references/elements-data-display.md`: Data display, media and code
- `references/elements-feedback.md`: Feedback and status
- `references/elements-form-controls.md`: Form controls
- `references/elements-form-layout.md`: Form layout
- `references/elements-layout.md`: Layout, structure and containers
- `references/elements-navigation.md`: Navigation
- `references/elements-overlays.md`: Overlays
