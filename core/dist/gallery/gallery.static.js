...
export const BREAKPOINTS = [
    { name: 'phone', px: 640, meaning: 'Single column, thumb-reachable. DataGrid becomes cards, Toolbar and Modal go full width, FlyoutPanel is full screen, the top bar shows the title and collapses the search to a button.' },
...
export const RESPONSIVE_RULES = [
    ...
    { width: '640px and below', change: 'One column. DataGrid rows become cards, Toolbar rows take the full width, Modal and FlyoutPanel go full screen, the top bar shows the title and the search becomes a button, and a workspace shows one panel at a time.' },
];
