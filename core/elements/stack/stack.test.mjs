// pk-stack is CSS-only layout: these tests hold its css to its API (every gap value maps to a spacing token) and its meta to the layout rules.
...
const read = ext => fs.readFileSync(fileURLToPath(new URL(`./stack.${ext}`, import.meta.url)), 'utf8');
