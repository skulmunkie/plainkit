...
export default define(class extends behaviour(PkElement) {
    ...
    static css = "/* pk-stepper: a row (or column) of pk-step children; the container sets each step's state, index and last. */\n:host { display: block; }\n\n[part=\"list\"] { display: flex; align-items: flex-start; gap: var(--space-2); }\n\n:host([orientation=\"vertical\"]) [part=\"list\"] { flex-direction: column; gap: 0; }\n";
});
