...
test('the page-level stylesheet and every element stay inside their own gzip budgets', () => {
...
test('every behaviour module stays inside the per-module gzip budget and the base set stays small', () => {
    const modules = ['js/theme', 'js/page', 'js/tasks', 'js/colour', 'js/quality', 'js/scoring', 'js/audit', 'js/plainkit', 'js/code-explorer/element', 'js/code-explorer/providers', 'js/code-explorer/tokenize', 'js/store', 'js/app', 'js/app/module', 'js/app/host', 'js/app/boundary'];
