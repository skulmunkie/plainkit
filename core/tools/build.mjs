...
export function build({ write = true } = {}) {
    ...
    w('dist/manifest.json', JSON.stringify({ name: 'plainkit', dependencies: [], runtimeRequests: 'none (same-origin only)', licence: 'MIT', provenance: 'Generated by sdk/tools/build.mjs from the sources; reproducible.', files }, null, 2) + '\n');
